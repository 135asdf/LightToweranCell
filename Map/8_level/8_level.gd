...
const CELL_TYPES := [
	{
		"name": "浆细胞",
		"texture": preload("res://Textures/images/towers/tower_plasma_cell/tower_plasma_cell.png"),
		"scene": preload("res://Towers/tower_plasma_cell/tower_plasma_cell.tscn"),
		"stats": { "fire_rate": 1.0, "damage": 20, "bullet_speed": 320.0 },
	},
]
# 本关会刷的怪物（和上面的塔一样，用多少就声明多少）。
const ENEMY_TYPES := [
	preload("res://Enemies/1_enemy/1_enemy.tscn"),
]
